      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: [
            AuthHeading("Sign Up to Tyamo", "Get connected with\nyour partner",
                "assets/images/icon.png", 18, 18, Color(0xff000221)),
            const SizedBox(
              height: 50,
            ),
            Auth_text_fields(false, Icons.alternate_email, 16, 16,
                TextInputType.emailAddress, 16, "Email"),
            const SizedBox(
              height: 20,
            ),
            Auth_text_fields(true, Icons.password, 16, 16,
                TextInputType.visiblePassword, 16, "Password"),
            const SizedBox(
              height: 30,
            ),
            Auth_text_fields(true, Icons.lock_reset, 16, 16,
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 15.sp,
                        color: Color.fromRGBO(2, 160, 245, 1),
                      ),
                    ),
                  )
                ],
